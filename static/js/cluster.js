...
var code_color = 'rgba(150, 131, 236, 0.5)';
var overcode_color = 'rgba(102, 0, 153, 0.5)';
...
var force = d3.layout.force()
  ...
  d3.json("static/data/sample.json", function(json) {
    ...
    $.each(clusters, function(k, v){v.overcode = true; nodes.push(v);});
    nodes.forEach(function(n) {n.radius = radius(n); if (!n.overcode) {n.overcode = false;}});
    ...
    .style("fill", function(d){return d.overcode ? overcode_color : code_color;})//function(d) { return color(d.cluster); })
.call(force.drag)
...
.text(function(d) { var txt= !d.code ? d.question : undefined; return txt;})
.style("font-size", function(d) { return Math.max(10, Math.min(2 * d.radius, (2 * d.radius - 8) / this.getComputedTextLength() * 12)) + "px"; })
.style("fill", "black")
.call(wrap, 50);
